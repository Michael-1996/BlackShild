      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-default">
            ...
            <div class="box-body">
              <a href="{{route('conge.create')}}" class="btn btn-primary" role="button">Ajouter un nouveau congé</a>
            </div>
          </div>
        </div>
      </div>
...
{{--               <div class="box-tools" style="margin-right: 30px">
            ...
            <!-- /.box-header -->
            <div class="box-body table-responsive no-padding" id="div_conge_table">


              @include('pages.conges.table')
