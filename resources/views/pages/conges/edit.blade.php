        ...
        <div class="row">
          ...
          <div class="col-md-8 offset-md-2">
            ...
            <div class="box box-primary">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form role="form" action="{{route('conge.update',$conge->id)}}" method="post"  enctype="multipart/form-data">
                @csrf
                @method('patch')
                <div class="box-body">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6 @error('date_debut')  has-error @enderror" style="padding-left: 0px">
                      ...
                      <input name="date_debut" type="date" class="form-control" value="{{old('date_debut') ?: $conge->date_debut}}">
                      @error('date_debut')
                          <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> {{$message}}</label>
                      @enderror
                    </div>
                    <div class="form-group col-md-6 @error('date_fin')  has-error @enderror" style="padding-right: 0px">
                      ...
                      <input name="date_fin" type="date" class="form-control" value="{{old('date_debut') ?: $conge->date_debut}}">
                      @error('date_fin')
                          <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> {{$message}}</label>
                      @enderror
                    </div>
                  ...
                  <div class="form-group @error('motif')  has-error @enderror">
                    ...
                    <textarea name="motif" rows="7" class="form-control">{{old('motif') ?: $conge->motif}}</textarea>
                    @error('motif')
                        <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> {{$message}}</label>
                    @enderror
                  </div>
