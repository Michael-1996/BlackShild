          ...
          <div class="col-md-8 offset-md-2">
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">Nouveau site</h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
              <form role="form" action="{{route('site.store')}}" method="post"  enctype="multipart/form-data">
                @csrf
                <div class="box-body">
                  ...
                  <div class="form-group @error('adresse')  has-error @enderror">
                    ...
                    <input name="adresse" type="text" class="form-control" id="exampleInputPassword1" placeholder="Entrer l'adresse" value="{{old('adresse') ?: ''}}">
                    @error('adresse')
                        <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> {{$message}}</label>
                    @enderror
                  </div>
                  <div class="form-group @error('email')  has-error @enderror">
                    ...
                    <input name="email" type="text" class="form-control" id="exampleInputPassword1" placeholder="Entrer l'email" value="{{old('email') ?: ''}}">
                    @error('email')
                        <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> {{$message}}</label>
                    @enderror
                  </div>
                  <div class="form-group @error('ville')  has-error @enderror">
                    ...
                    <input name="ville" type="text" class="form-control" id="exampleInputPassword1" placeholder="Entrer le ville" value="{{old('ville') ?: ''}}">
                    @error('ville')
                        <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> {{$message}}</label>
                    @enderror
                  </div>
...
{{--                   <div class="form-group @error('photo')  has-error @enderror">
                    ...
                    <input name="photo" type="file" id="exampleInputFile" value="{{old('photo') ?: ''}}">
                    @error('photo')
                        <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> {{$message}}</label>
                    @enderror
                  </div> --}}
